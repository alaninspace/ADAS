...
## Phase 2: Frontend - UI Scaffolding & State Management [checkpoint: 18f1f07]
- [x] Task: Write failing tests for UI state management (Model Picker, Agent Selector).
- [x] Task: Implement state management models and services for the new Chat UI selections.
- [x] Task: Phase Verification & Checkpoint (Refer to workflow.md)

## Phase 3: Frontend - Premium Chat UI Implementation
- [x] Task: Write failing component tests for the new chat components (Model Picker, Agent Selector, Message List, Input Box).
